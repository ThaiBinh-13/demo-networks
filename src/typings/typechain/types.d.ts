...
import { CallBackFunc } from "../common";
...
export interface NonPayableTransactionObject<T> {
  ...
  send(tx?: NonPayableTx, callback?: CallBackFunc): PromiEvent<TransactionReceipt>;
...
export interface PayableTransactionObject<T> {
  ...
  send(tx?: PayableTx, callback?: CallBackFunc): PromiEvent<TransactionReceipt>;
